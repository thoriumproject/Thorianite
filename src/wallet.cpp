...
// Thorianite: total coins staked (non-spendable until maturity)
...
// Thorianite: get current stake weight
...
// Thorianite: check 'spent' consistency between wallet and txindex
// Thorianite: fix wallet spent state according to txindex
...
// Thorianite: disable transaction (only for coinstake)
