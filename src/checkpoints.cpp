...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
      ...
      ( 0,      hashGenesisBlock )
      ( 1,      uint256("0x00000e7dc130c84ec181ef743b96ed444afd1615e124e6a021d7cbf2284befff"))
    ...
    // Thorianite: synchronized checkpoint (centrally broadcasted)
    ...
    // Thorianite: get last synchronized checkpoint
    ...
    // Thorianite: only descendant of current sync-checkpoint is allowed
    ...
    // Thorianite: reset synchronized checkpoint to last hardened checkpoint
...
// Thorianite: verify signature of sync-checkpoint message
...
// Thorianite: process synchronized checkpoint
