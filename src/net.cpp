...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Thorianite-ext-ip");
...
void ThreadMapPort2(void* parg)
{
   ...
   devlist = upnpDiscover(2000, multicastif, minissdpdpath, 0, 0, 2, &error);
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Thorianite " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"thor.point2this.com", "thor.point2this.com"},
    {"", ""},
};
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("Thorianite-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Thorianite-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Thorianite-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Thorianite-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Thorianite is probably already running."), addrBind.ToString().c_str());
        else
